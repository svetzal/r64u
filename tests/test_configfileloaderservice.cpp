...
private slots:
    ...
    {
        QJsonObject result = ConfigFileLoaderService::parseConfigFile(QByteArray());
        QVERIFY(result.isEmpty());
    }

    void testParseWhitespaceOnly()
    {
        QJsonObject result = ConfigFileLoaderService::parseConfigFile("   \n\t\n  ");
        QVERIFY(result.isEmpty());
    }
...
QTEST_MAIN(TestConfigFileLoaderService)
#include "test_configfileloaderservice.moc"
