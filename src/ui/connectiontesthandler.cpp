...
void ConnectionTestHandler::startTest(const QString &host, const QString &password)
{
    if (host.isEmpty()) {
    ...
    connect(testClient_, &IRestClient::connectionError, this,
            &ConnectionTestHandler::onTestConnectionError);

    QApplication::setOverrideCursor(Qt::WaitCursor);
    testClient_->getInfo();
}

void ConnectionTestHandler::onTestConnectionSuccess(const DeviceInfo &info)
{
