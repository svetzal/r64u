#ifndef ILOCALFILESYSTEMSERVICE_H
#define ILOCALFILESYSTEMSERVICE_H
 ...
 * @code
 * // Production code
 * ILocalFileSystemService *fs = new LocalFileSystemService(this);
 *
 * // Test code
 * ILocalFileSystemService *fs = new MockLocalFileSystemService(this);
 *
 * // Both are used identically
 * fs->createDirectoryPath("/tmp/downloads/subdir");
 * @endcode
 */
class ILocalFileSystemService : public QObject
{
    Q_OBJECT
...
public:
     ...
     */
    explicit ILocalFileSystemService(QObject *parent = nullptr) : QObject(parent) {}

    /// Destructor.
    ~ILocalFileSystemService() override = default;
...
#endif  // ILOCALFILESYSTEMSERVICE_H
