...
sidfile::SidFileParser::SidInfo sidfile::SidFileParser::parse(const QByteArray &data)
{
    SidInfo info;
...
QString sidfile::SidFileParser::formatForDisplay(const SidInfo &info)
{
    if (!info.valid) {
...
QString sidfile::SidFileParser::sidModelToString(SidModel model)
{
    switch (model) {
...
QString sidfile::SidFileParser::videoStandardToString(VideoStandard standard)
{
    switch (standard) {
...
quint16 sidfile::SidFileParser::readWord(const QByteArray &data, int offset)
{
...
quint32 sidfile::SidFileParser::readLongword(const QByteArray &data, int offset)
{
...
QString sidfile::SidFileParser::readString(const QByteArray &data, int offset, int maxLen)
{
    if (offset >= data.size()) {
        return QString();
    }
...
sidfile::SidFileParser::SidModel sidfile::SidFileParser::decodeSidModel(int bits)
{
    switch (bits) {
    case 1:
...
sidfile::SidFileParser::VideoStandard sidfile::SidFileParser::decodeVideoStandard(int bits)
{
    switch (bits) {
    case 1:
