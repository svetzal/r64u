#ifndef SONGLENGTHSDATABASESERVICE_H
...
public:
    ...
    explicit SonglengthsDatabaseService(IFileDownloaderService *downloader,
                                        QObject *parent = nullptr);
    ~SonglengthsDatabaseService() override = default;
...
#endif  // SONGLENGTHSDATABASESERVICE_H
