/**
 * @file mocklocalfilesystemservice.h
 * @brief Mock local file system for unit testing.
 *
 * Implements ILocalFileSystemService with configurable responses and call tracking,
 * following the same Spy/Stub pattern used by MockFtpClient.
 */

#ifndef MOCKLOCALFILESYSTEMSERVICE_H
#define MOCKLOCALFILESYSTEMSERVICE_H
...
/**
 * @brief Mock local file system implementing ILocalFileSystemService for testing.
 *
 ...
 * @par Example usage:
 * @code
 * MockLocalFileSystemService *mockFs = new MockLocalFileSystemService(this);
 ...
 * @endcode
 */
class MockLocalFileSystemService : public ILocalFileSystemService
{
    Q_OBJECT

public:
    explicit MockLocalFileSystemService(QObject *parent = nullptr);
    ~MockLocalFileSystemService() override = default;

    /// @name ILocalFileSystemService Implementation
    /// @{
...
#endif  // MOCKLOCALFILESYSTEMSERVICE_H
