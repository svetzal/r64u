 ...
 * @par Example usage:
 * @code
 * AudioStreamReceiverService *receiver = new AudioStreamReceiverService(this);
 *
 ...
 * @endcode
 */
class AudioStreamReceiverService : public IAudioStreamReceiverService
{
    Q_OBJECT
...
public:
    ...
    using AudioFormat = IAudioStreamReceiverService::AudioFormat;
    ...
    explicit AudioStreamReceiverService(QObject *parent = nullptr);
    ~AudioStreamReceiverService() override;
...
#endif  // AUDIOSTREAMRECEIVERSERVICE_H
