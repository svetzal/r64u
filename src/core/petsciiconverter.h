 ...
 *
 * This namespace provides conversion utilities for displaying PETSCII text
...
// Backward-compatible alias so existing code compiles unchanged
using PetsciiConverter = petscii::PetsciiConverter;
