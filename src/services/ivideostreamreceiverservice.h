#ifndef IVIDEOSTREAMRECEIVERSERVICE_H
#define IVIDEOSTREAMRECEIVERSERVICE_H
 ...
 */
class IVideoStreamReceiverService : public QObject
{
    Q_OBJECT
...
public:
    ...
    explicit IVideoStreamReceiverService(QObject *parent = nullptr) : QObject(parent) {}
    ~IVideoStreamReceiverService() override = default;
...
#endif  // IVIDEOSTREAMRECEIVERSERVICE_H
