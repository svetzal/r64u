#ifndef VIDEOSTREAMRECEIVERSERVICE_H
#define VIDEOSTREAMRECEIVERSERVICE_H
 ...
 * @par Example usage:
 * @code
 * VideoStreamReceiverService *receiver = new VideoStreamReceiverService(this);
 *
 ...
 * @endcode
 */
class VideoStreamReceiverService : public IVideoStreamReceiverService
{
    Q_OBJECT
...
public:
    ...
    /// Type alias for backward compatibility with callers using
    /// VideoStreamReceiverService::VideoFormat
    using VideoFormat = IVideoStreamReceiverService::VideoFormat;
     ...
     */
    explicit VideoStreamReceiverService(QObject *parent = nullptr);

    /**
     * @brief Destructor. Closes the socket.
     */
    ~VideoStreamReceiverService() override;
...
#endif  // VIDEOSTREAMRECEIVERSERVICE_H
