#ifndef IAUDIOSTREAMRECEIVERSERVICE_H
#define IAUDIOSTREAMRECEIVERSERVICE_H
 ...
 */
class IAudioStreamReceiverService : public QObject
{
    Q_OBJECT
...
public:
    ...
    explicit IAudioStreamReceiverService(QObject *parent = nullptr) : QObject(parent) {}
    ~IAudioStreamReceiverService() override = default;
...
#endif  // IAUDIOSTREAMRECEIVERSERVICE_H
