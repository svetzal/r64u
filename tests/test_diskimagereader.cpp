...
private slots:
    ...
    {
        auto dir = DiskImageReader::parse(QByteArray());
    ...
    void testParseD64BySize()
    {
        ...
        auto dir = DiskImageReader::parse(data, "");  // No filename hint
    ...
    void testParseD64WithErrorBytes()
    {
        ...
        auto dir = DiskImageReader::parse(data, "");
        QCOMPARE(dir.format, DiskImageReader::Format::D64);
    }
    ...
    void testParseByFilename()
    {
        ...
        auto dirD64 = DiskImageReader::parse(data, "game.d64");
        QCOMPARE(dirD64.format, DiskImageReader::Format::D64);

        auto dirD71 = DiskImageReader::parse(data, "game.d71");
        QCOMPARE(dirD71.format, DiskImageReader::Format::D71);

        auto dirD81 = DiskImageReader::parse(data, "game.d81");
    ...
    void testParseD64DiskName()
    {
        ...
        auto dir = DiskImageReader::parse(data, "test.d64");
