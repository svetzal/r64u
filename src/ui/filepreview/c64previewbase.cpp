/**
 * @file c64previewbase.cpp
 * @brief Implementation of the shared C64 preview base class.
 */
...
C64PreviewBase::C64PreviewBase(QObject *parent) : QObject(parent) {}

QWidget *C64PreviewBase::createPreviewWidget(QWidget *parent)
{
    ...
    // Text browser for content display
...
void C64PreviewBase::showError(const QString &error)
{
    if (textBrowser_) {
